...
<p><b>For any questions or support, please contact: <a href="mailto:nep@asdc.org.in">nep@asdc.org.in</a></b></p>
            ...
            <div class="text-center">
                <a class="common-btn short" href="">Start Now</a>
            </div>
            </div>
                        ...
                        <div class="item md:w-1/4">
                            ...
                            <div class="item md:w-3/4">
                                <div class="dashboared-items d-flex md:justify-end md:gap-4">
                                    <a href="/school_login" class="item items-center justify-between  d-flex">
                                    ...
                                    <a href="/studentlistadmin" class="item items-center justify-between  d-flex">
                                    <div class="items-center justify-between d-flex">
                                        <span class="icon"><img src="{{ asset('/assets/images/icon-participants.png') }}" alt=""></span>
                                        <div class="text">
                                    ...
                                    <a href="/tests" class="item items-center justify-between  d-flex">
                                    <div class="items-center justify-between d-flex">
                                    ...
                                    <a href="/student-list" class="item items-center justify-between  d-flex">
                                    <div class="items-center justify-between d-flex">
                                        <span class="icon"><img src="{{ asset('/assets/images/icon-participants.png') }}" alt=""></span>
                                        <div class="text">
