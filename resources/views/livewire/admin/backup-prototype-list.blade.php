<div class="common-sec">
                        ...
                        <table class="min-w-full border divide-y divide-gray-200">
                            ...
                            <tbody>
                                                                                ...
                                                                                <li class="d-flex">
                                                                                    <a class="common-btn admin-btn d-flex items-center"
                                                                                        ...
                                                                                        <span class="reverse-pos"><img
                                                                                                src="https://byd-innovate-a-thon.asdc.org.in/assets/images/icon-upload.png"
                                                                                                alt=""></span>
                                                                    ...
                                                                    @if(($teamName))
                                                                        <td align="center">
                                                                            @if($teamName->approved_level2 == 1)
                                                                                <span type="button" class="table-btn green no-hov">Approved</span>
                                                                            @else
                                ...
                                @empty
                                    ...
                                    <tr >
                                        <td id="no-submissions" colspan="8"
    ...
    <div class="verify-sec" id="dialog-contents">
        <div class="inner">
            <button type="button" class="close" id="close-btn">X</button>
            <p><b>Are sure you want approve?</b></p>
            <div class="buttons-sec d-flex justify-center w-100 links mt-6">
                <button type="button" class="common-btn green" id="confirmApproveButton">Approve</button>
                <button type="button" class="common-btn red" id="close">Reject</button>
            </div>
        </div>
    </div>
