        ...
        <div class="overflow-hidden bg-white">
            <div class="">
                ...
                @forelse($prototypes as $admin)
                    ...
                    @if($userP->level2enddate >= $currentDate)
                        <div class="mb-4">
                            <a href="{{ route('submisson') }}" class="common-btn short">
                                Upload Prototype
                            </a>
                        </div>
                    @endif
            ...
            <a class="common-btn admin-btn d-flex items-center"  href="{{ url($admin->file) }}" download target="_blank">
                ...
                <span>Prototype File Download</span>
                                ...
                                <td align="center">
                                    ...
                                    @else
                                    @if($userP->level2enddate >= $currentDate)
                                    <a class="table-btn red approve-button" href="{{ route('submisson.edit',  $admin->id ) }}">
                                      Edit
                                       </a>
                                       @else
                                       <button  class="table-btn green">Submitted</button>
